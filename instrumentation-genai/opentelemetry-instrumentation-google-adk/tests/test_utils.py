...
class TestContentCapture:
    ...
    def test_get_max_length_default(self):
        ...
        os.environ.pop('OTEL_INSTRUMENTATION_GENAI_MESSAGE_CONTENT_MAX_LENGTH', None)
    ...
    def test_get_max_length_custom(self):
        ...
        os.environ['OTEL_INSTRUMENTATION_GENAI_MESSAGE_CONTENT_MAX_LENGTH'] = '1000'
    ...
    def test_get_max_length_invalid(self):
        ...
        os.environ['OTEL_INSTRUMENTATION_GENAI_MESSAGE_CONTENT_MAX_LENGTH'] = 'invalid'
    ...
    def test_process_content_with_custom_max_length(self):
        ...
        os.environ['OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT'] = 'true'
        os.environ['OTEL_INSTRUMENTATION_GENAI_MESSAGE_CONTENT_MAX_LENGTH'] = '100'
        content = "B" * 200
        result = process_content(content)
