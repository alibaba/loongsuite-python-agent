...
def safe_json_dumps(obj: Any, max_length: int = 1024, respect_env_limit: bool = False) -> str:
    """
...
def safe_json_dumps_large(obj: Any, max_length: int = 1048576, respect_env_limit: bool = True) -> str:
    """
...
def extract_content_safely(content: Any, max_length: int = 1024, respect_env_limit: bool = True) -> str:
    """
...
def extract_content_safely_for_input_output(content: Any) -> str:
    ...
    """
    return extract_content_safely(content, max_length=1048576, respect_env_limit=True)
