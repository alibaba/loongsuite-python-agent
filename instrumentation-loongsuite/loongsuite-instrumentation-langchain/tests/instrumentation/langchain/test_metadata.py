    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # 测试只有user_id，没有session_id
            {
                ...
                "run_extra": {
                    "metadata": {"user_id": "user_only", "env": "test"}
                },
                "expected": [
                    (LLM_USER_ID, "user_only"),
                    (
                        METADATA,
                        json.dumps({"user_id": "user_only", "env": "test"}),
                    ),
                ],
            },
            ...
            # 测试没有metadata键
            {
                ...
                "run_extra": {"other_key": "other_value"},
                "expected": [],
            },
            # 测试None的run_extra
            {"name": "none_run_extra", "run_extra": None, "expected": []},
            # 测试空run_extra
            {"name": "empty_run_extra", "run_extra": {}, "expected": []},
            # 测试包含无效类型的metadata
            {
                "name": "invalid_metadata_type",
                "run_extra": {"metadata": "not a dict"},
                "expected": [],
            },
