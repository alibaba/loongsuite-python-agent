...
libraries = [
    {
        ...
        "instrumentation": "loongsuite-instrumentation-openai-v2==0.1.0",
    },
    {
        "library": "google-cloud-aiplatform >= 1.64",
        "instrumentation": "loongsuite-instrumentation-vertexai==0.1.0",
    },
    {
    ...
    },
    {
        ...
        "instrumentation": "loongsuite-instrumentation-agentscope==0.1.0",
    },
    {
        "library": "agno",
        "instrumentation": "loongsuite-instrumentation-agno==0.1.0",
    },
    {
        "library": "claude-agent-sdk >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-claude-agent-sdk==0.1.0",
    },
    {
    ...
    },
    {
        ...
        "instrumentation": "loongsuite-instrumentation-langchain==0.1.0",
    },
    {
...
default_instrumentations = [
    ...
    "loongsuite-instrumentation-dify==0.1.0",
]
