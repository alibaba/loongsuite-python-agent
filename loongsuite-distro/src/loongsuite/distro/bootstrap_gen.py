...
#   --loongsuite-version: 0.3.0

libraries = [
    {
        "library": "openai >= 1.26.0",
        "instrumentation": "loongsuite-instrumentation-openai-v2==0.3.0",
    },
    {
        "library": "google-cloud-aiplatform >= 1.64",
        "instrumentation": "loongsuite-instrumentation-vertexai==0.3.0",
    },
    {
    ...
    },
    {
        ...
        "instrumentation": "loongsuite-instrumentation-agentscope==0.3.0",
    },
    {
        "library": "agno",
        "instrumentation": "loongsuite-instrumentation-agno==0.3.0",
    },
    {
        "library": "claude-agent-sdk >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-claude-agent-sdk==0.3.0",
    },
    {
        "library": "crewai >= 0.80.0",
        "instrumentation": "loongsuite-instrumentation-crewai==0.3.0",
    },
    {
        "library": "dashscope >= 1.0.0",
        "instrumentation": "loongsuite-instrumentation-dashscope==0.3.0",
    },
    {
        "library": "google-adk >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-google-adk==0.3.0",
    },
    {
        "library": "langchain_core >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-langchain==0.3.0",
    },
    {
        "library": "langgraph >= 0.2",
        "instrumentation": "loongsuite-instrumentation-langgraph==0.3.0",
    },
    {
        "library": "litellm >= 1.0.0",
        "instrumentation": "loongsuite-instrumentation-litellm==0.3.0",
    },
    {
        "library": "mcp >= 1.3.0, <= 1.25.0",
        "instrumentation": "loongsuite-instrumentation-mcp==0.3.0",
    },
    {
        "library": "mem0ai >= 1.0.0",
        "instrumentation": "loongsuite-instrumentation-mem0==0.3.0",
    },
]
...
default_instrumentations = [
    ...
    "loongsuite-instrumentation-dify==0.3.0",
]
