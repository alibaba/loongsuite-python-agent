...
#   --upstream-version: 0.61b0
#   --loongsuite-version: 0.4.0

libraries = [
    {
        "library": "openai >= 1.26.0",
        "instrumentation": "loongsuite-instrumentation-openai-v2==0.4.0",
    },
    {
        "library": "google-cloud-aiplatform >= 1.64",
        "instrumentation": "loongsuite-instrumentation-vertexai==0.4.0",
    },
    {
    ...
    {
        "library": "aiohttp ~= 3.0",
        "instrumentation": "opentelemetry-instrumentation-aiohttp-client==0.61b0",
    },
    {
        "library": "aiohttp ~= 3.0",
        "instrumentation": "opentelemetry-instrumentation-aiohttp-server==0.61b0",
    },
    {
    ...
    },
    {
        ...
        "instrumentation": "opentelemetry-instrumentation-confluent-kafka==0.61b0",
    },
    {
        "library": "django >= 2.0",
    ...
    },
    {
        ...
        "instrumentation": "opentelemetry-instrumentation-elasticsearch==0.61b0",
    },
    {
    ...
    },
    {
        ...
        "instrumentation": "opentelemetry-instrumentation-kafka-python==0.61b0",
    },
    {
    ...
    {
        "library": "psutil >= 5",
        "instrumentation": "opentelemetry-instrumentation-system-metrics==0.61b0",
    },
    {
    ...
    },
    {
        ...
        "instrumentation": "loongsuite-instrumentation-agentscope==0.4.0",
    },
    {
        "library": "agno",
        "instrumentation": "loongsuite-instrumentation-agno==0.4.0",
    },
    {
        "library": "claude-agent-sdk >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-claude-agent-sdk==0.4.0",
    },
    {
        "library": "copaw >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-copaw==0.4.0",
    },
    {
        "library": "crewai >= 0.80.0",
        "instrumentation": "loongsuite-instrumentation-crewai==0.4.0",
    },
    {
        "library": "dashscope >= 1.0.0",
        "instrumentation": "loongsuite-instrumentation-dashscope==0.4.0",
    },
    {
        "library": "google-adk >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-google-adk==0.4.0",
    },
    {
        "library": "langchain_core >= 0.1.0",
        "instrumentation": "loongsuite-instrumentation-langchain==0.4.0",
    },
    {
        "library": "langgraph >= 0.2",
        "instrumentation": "loongsuite-instrumentation-langgraph==0.4.0",
    },
    {
        "library": "litellm >= 1.0.0",
        "instrumentation": "loongsuite-instrumentation-litellm==0.4.0",
    },
    {
        "library": "mcp >= 1.3.0, <= 1.25.0",
        "instrumentation": "loongsuite-instrumentation-mcp==0.4.0",
    },
    {
        "library": "mem0ai >= 1.0.0",
        "instrumentation": "loongsuite-instrumentation-mem0==0.4.0",
    },
]
...
default_instrumentations = [
    ...
    "loongsuite-instrumentation-dify==0.4.0",
]
